...
/**
 * Servicio de criptografía para operaciones criptográficas.
 * Proporciona cifrado simétrico, asimétrico y funciones de hash.
 *
 * Propósito de seguridad:
 * - Cifrado AES-256-GCM para datos sensibles
 * - Generación de claves Ed25519/RS256
